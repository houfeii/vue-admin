  ...
  <div class="fm-style">
    <el-container class="fm2-container">
      ...
      <el-footer height="30px" style="font-weight: 600;">
        Powered by <a target="_blank" href="https://github.com/GavinZhuLei/vue-form-making">vue-form-making</a>
      </el-footer>
    </el-container>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    advanceFields: {
      type: Array,
      default: () => ['blank', 'imgupload', 'videoupload', 'editor', 'cascader']
    },
    layoutFields: {
      type: Array,
      default: () => ['grid']
  ...
  methods: {
    _loadComponents () {
      ...
      this.advanceComponents = this.advanceComponents.map(item => {
        console.log(`fm.components.fields.${item.type}`)
        return {
          ...item,
          name: this.$t(`fm.components.fields.${item.type}`)
        }
